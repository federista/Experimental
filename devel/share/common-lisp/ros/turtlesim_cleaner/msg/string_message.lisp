...
(cl:defmethod cl:initialize-instance :after ((m <string_message>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'string_message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlesim_cleaner-msg:<string_message> is deprecated: use turtlesim_cleaner-msg:string_message instead.")))

(cl:ensure-generic-function 'custom_msg-val :lambda-list '(m))
(cl:defmethod custom_msg-val ((m <string_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlesim_cleaner-msg:custom_msg-val is deprecated.  Use turtlesim_cleaner-msg:custom_msg instead.")
  (custom_msg m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<string_message>)))
  ...
  "turtlesim_cleaner/string_message")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'string_message)))
  "Returns string type for a message object of type 'string_message"
  "turtlesim_cleaner/string_message")
